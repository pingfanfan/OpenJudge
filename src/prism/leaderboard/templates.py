...
<p class="note">Scores are pass@1 (higher is better).
Generated by <code>prism leaderboard publish</code>.</p>
{main_section}
{staircase_section}
{sweep_section}
</body>
...
<table>
<thead><tr><th>Base Model</th><th>Variant</th><th>Effort</th>
<th>Mean Score</th><th>Total Cost</th></tr></thead>
<tbody>
{rows}
</tbody>
</table>
